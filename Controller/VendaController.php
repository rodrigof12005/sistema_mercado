...
class VendaController
{
    ...
    {
        $this->Venda->createVenda($id_produto, $valor_unitario, $imposto, $cliente, $descricao, $quantidade , $valor_total,$pedido,$totalImpostos,$totalVenda, $totalImpostoUnitario);
    }
